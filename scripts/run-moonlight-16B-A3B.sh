...
CKPT_ARGS=(
   --hf-checkpoint /root/data/Moonlight-16B-A3B
   --ref-load /root/data/Moonlight-16B-A3B_torch_dist
   --load /root/data/Moonlight-16B-A3B_slime/
   --save /root/data/Moonlight-16B-A3B_slime/
   --save-interval 20
)
